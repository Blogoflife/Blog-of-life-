const NUM_MAX_CARDS = 16
const NUM_TUPLE     = 2 

const Cards = [[1,
   {
    id:1,  
    source: "./img/foto4.jpg"
  }],[2,

  {
    id:2,             source:"./img/foto2.jpg",
  }],[3,
  
  {
    id:3,   
 source:"./img/foto3.jpg",
  }],[4,
  
  {
    id:4,      source:"./img/foto1.jpg",
  }],[5,
  
  {
    id:5,      source:"./img/foto5.jpg",
  }], [6,
  
  {
    id:6,      source:"./img/foto6.jpg",
  }],[7,
    {
      id:7, source:"./img/foto7.png",
    }],[8,
      {
        id:8, source:"./img/foto8.jpg",
      }]
]
...
class Game{  
  constructor(onEndGame, elCanvas) {
    ...
    this.numTuplesOK = 0
    this.numClicks = 0
    this.resultArray = ["ʘ‿ʘ ممتاز!", "(´･_･`) فاز - ربح", "¯\\_(ツ)_/¯ اللعبة ^-^ "]
